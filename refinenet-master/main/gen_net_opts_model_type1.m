...
train_opts.epoch_run_max_task_one_class=1000;
...
function featnet_config=gen_featnet_config_resnet_custom(train_opts, init_resnet_layer, img_scale, output_path_num, start_stage_idx)
    ...
    featnet_config.pre_trained_model_file=sprintf('D:/TUHH/Arbeit/refinenet-master/refinenet-master/model_trained/imagenet-resnet-%d-dag.mat', init_resnet_layer);
...
input_featnet_configs{1}=gen_featnet_config_resnet_custom(train_opts, resnet_layer_num, 1, 4, 1);
