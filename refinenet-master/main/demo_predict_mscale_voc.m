...
function demo_predict_mscale_voc()
...
ds_name_subfix='voc2012';

% result dir:
result_name=['result_' datestr(now, 'mmDDHHMM') '_predict_custom_data'];
result_dir=fullfile('D:/TUHH/Arbeit/refinenet-master/refinenet-master/cache_data', ['test_examples_' ds_name_subfix], result_name);
...
% run_config.trained_model_path='D:\TUHH\Arbeit\refinenet-master\refinenet-master\model_trained\net-config-snapshot.mat'; % trained model 195
...
%img_data_dir='D:\TUHH\Arbeit\refinenet-master\refinenet-master\datasets\example_imgs_voc';
img_data_dir='D:\TUHH\Arbeit\Data\VOCdevkit\voc2012_trainval\JPEGImages_boat';
...
gt_mask_dir='D:\TUHH\Arbeit\Data\VOCdevkit\voc2012_trainval\SegmentationClass';
...
prediction_scales=[1.0]; % or only use 1 scale
%-------------------------------------------------------------------------------------------------------------------------
