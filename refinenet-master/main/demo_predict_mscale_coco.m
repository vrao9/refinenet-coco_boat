...
function demo_predict_mscale_coco()
...
img_data_dir='D:\TUHH\Arbeit\Data\val2017_coco_temp';
...
ds_info.test_idxes = ds_info.test_idxes(1:3);
my_diary_flush();
